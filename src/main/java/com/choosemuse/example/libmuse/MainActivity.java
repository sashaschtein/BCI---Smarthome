...
public class MainActivity extends Activity implements OnClickListener {
    ...
    /**
     * Creates a DatabaseReference object that allows us to access elements in the Firebase Database
     */
    DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();

    /**
     * Allows us to access the current status of our LED
     */
   ...
   // --------------------------------------
    ...
    /**
     * Calculates the average alpha level based on the current Muse headset readings and determines
     * the state of the LED.
     * @param aBuffer       The array of alpha level frequencies
     * @param aThreshold    The required average alpha level to trigger the LED
     */
